      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form action="b_contacto.php" class="p-5 bg-white border" name="form2" method="post">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="font-weight-bold" for="asun">Asunto</label>
                  <input type="text" id="subject" name="subject" class="form-control" placeholder="Ingrese Asunto">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="message" id="message" cols="30" rows="5" class="form-control" placeholder="Su Mensaje "></textarea>
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              <h3 class="h6 text-black mb-3 text-uppercase">Informacion del Contacto</h3>
              <p class="mb-0 font-weight-bold">Direccion</p>
              <p class="mb-4">Calle Montesino y Bolivar 203, Tarija Bolvia</p>

              <p class="mb-0 font-weight-bold">Telefono</p>
              <p class="mb-4"><a href="#">+591 2457789- 71489878</a></p>

              <p class="mb-0 font-weight-bold">Correo Electronico</p>
              <p class="mb-0"><a href="#">miemail@domain.com</a></p>
