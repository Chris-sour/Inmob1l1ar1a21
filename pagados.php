...
<script src="js/bootstrap.min.js"></script>
    ...
    <script src="login/js/myjavaMobil2.js"></script>
  </head>
  <body>
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(images/agente2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
            <h1 class="mb-2">Avisos Pagados</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-9 col-lg-9 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="p-4 bg-white">
             <!-- <span class="d-block text-secondary small text-uppercase">Jan 20th, 2019</span>-->
              <h2 class="h5 text-black mb-3"><a href="#">Que es el Codigo ?</a></h2>
              <p>Cuando envia el formulario solicitando informacion, sobre algun AVISO y realizando el PAGO, el administrador le envia un codigo a su
              correo, u otro medio de contacto. Con este CODIGO puede ver, imprimir  y descargar la informacion del AVISO en detalle.</p>
            </div>
            
              	<div class="col-lg-7">
    				<div class="input-group">
     				<input type="text" class="form-control" placeholder="Escriba el CODIGO" id="codigo" >
      				<span class="input-group-btn">
                    <button type="button" class="btn btn-info"> Buscar Codigo</button>
      				</span>
    				</div>
  				</div>
          </div>
            ...
            <div class="row mb-5">
              ...
              <div class="col-md-6 col-lg-6">
                <ul class="list-unstyled">
                  ...
                  <li><a href="registraAviso.php">Registre Avisos GRATIS</a></li>
                  <li><a href="citas.php">Reserve una Cita</a></li>
                  <li><a href="buscar.php">Buscar Avisos</a></li>
                </ul>
              </div>
